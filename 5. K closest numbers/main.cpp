...
void solve() {
    ...
    // Max heap to store {difference, value}
    // We want largest difference at top, so we can pop it if heap size exceeds k
    //thus make a max heap (maximum difference at top ) and not a min heap
